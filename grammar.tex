...
Die Präpositionen \emph{von}, \emph{durch} oder \emph{mit} können benutzt werden.
\begin{description}
  \item[von + Dativ:] ,,Täter'', Personen und Institutionen: vom Reiseleiter, von den Vereinten Nationen
  \item[durch + Akkusativ:]: Vorgänge und Vermittler: durch den Anschlag, durch einen Boten
  \item[mit + Dativ:] Instrumente: mit einer Schere, mir der neuen Technologie
\end{description}
